...
{
    public static final String ACTION_CHOOSE_DIRECTORY = "com.onetwodevs.intent.action.CHOOSE_DIRECTORY";
    public static final String ACTION_CHOOSE_FILE = "com.onetwodevs.intent.action.CHOOSE_FILE";
