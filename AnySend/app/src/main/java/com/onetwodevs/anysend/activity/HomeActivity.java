...
import com.onetwodevs.anysend.dialog.ShareAppDialog;
import com.onetwodevs.anysend.fragment.HomeFragment;
...
//        }
    ...
    public void onBackPressed() {
        ...
        if (mDrawerLayout != null && mDrawerLayout.isDrawerOpen(GravityCompat.START))
            ...
            AppUtils.startForegroundService(context, new Intent(context, CommunicationService.class)
                    .setAction(CommunicationService.ACTION_END_SESSION));
            super.onBackPressed();
        } else {
    ...
    private void applyAwaitingDrawerAction() {
        if (mChosenMenuItemId == 0) {
            ...
            try {
                startActivity(new Intent(this, Class.forName("com.genonbeta.anysend.activity.DonationActivity")));
            } catch (ClassNotFoundException e) {
                e.printStackTrace();
            }
            Toast.makeText(context, "Thanks for showing us interest, this feature will available soon", Toast.LENGTH_SHORT).show();
