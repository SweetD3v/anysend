...
import com.onetwodevs.anysend.adapter.NetworkDeviceListAdapter;
...
import com.onetwodevs.anysend.service.DeviceScannerService;
import com.onetwodevs.anysend.ui.UIConnectionUtils;
import com.onetwodevs.anysend.ui.callback.DetachListener;
...
public class NetworkDeviceListFragment
    ...
    private void openInfo(NetworkDevice device) {
        if (device instanceof NetworkDeviceListAdapter.HotspotNetwork) {
            ...
            builder.setMessage(R.string.text_AnySendHotspotDescription);
