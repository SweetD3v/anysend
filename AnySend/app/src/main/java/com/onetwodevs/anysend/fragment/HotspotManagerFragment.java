...
import com.onetwodevs.anysend.GlideApp;
import com.onetwodevs.anysend.R;
import com.onetwodevs.anysend.config.Keyword;
import com.onetwodevs.anysend.receiver.NetworkStatusReceiver;
...
public class HotspotManagerFragment
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        anim_ll = view.findViewById(R.id.anim_ll);
        ...
        anim = ObjectAnimator.ofInt(anim_ll, "backgroundColor",
