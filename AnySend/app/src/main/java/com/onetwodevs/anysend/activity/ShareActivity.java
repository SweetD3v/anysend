...
import com.onetwodevs.anysend.task.OrganizeShareRunningTask;
...
public class ShareActivity extends Activity
    ...
    public static final String ACTION_SEND = "onetwodevs.intent.action.TREBLESHOT_SEND";
    public static final String ACTION_SEND_MULTIPLE = "onetwodevs.intent.action.TREBLESHOT_SEND_MULTIPLE";
    ...
    /**
     * @see OrganizeShareRunningTask
     * which contains the main process code of sharing the files
     */
