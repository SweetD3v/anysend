package com.onetwodevs.anysend.database;
...
public class AccessDatabase extends SQLiteDatabase {
    ...
    public static final String ACTION_DATABASE_CHANGE = "com.onetwodevs.intent.action.DATABASE_CHANGE";
